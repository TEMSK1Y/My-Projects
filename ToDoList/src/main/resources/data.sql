...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (7, 'Admin', 'First', 'admin', '$2y$10$wIhQhDlTF9qU2jskD4d/KuIWjHlV18./clGEZH1lFY2dfAx/K0Mhq', 1);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (8, 'User', 'Second', 'user', '$2y$10$o6IsLdmeiCj3EBE84Tx2iOx9vgFAVQeKNlFyOEdJViVMXxUnBxaAG', 2);
...
INSERT INTO tasks (id, name, priority, todo_id, state_id) VALUES (8, 'Task #4', 'MEDIUM', 8, 6);
